...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index.php" class="logo">
      ...
      <span class="logo-lg"><b>My</b>HOSPITAL</span>
    </a>
    <!-- Header Navbar -->
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            ...
            <a href="" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs">Elezky M</span>
            </a>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> My hospital</a></li>
  ...
  <footer class="main-footer">
    <!-- Default to the left -->
    <strong>Copyright &copy; 2021 <a href="">Coding Infinite</a>.</strong> All rights reserved.
  </footer>
